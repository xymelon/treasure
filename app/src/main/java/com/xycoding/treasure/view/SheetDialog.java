...
/**
 * Fix bug: BottomSheetDialog remains hidden after dismiss by dragging down.
 * <p>
 * Created by xuyang on 2016/9/28.
 */
public class SheetDialog extends AppCompatDialog {
    ...
    protected SheetDialog(@NonNull Context context, boolean cancelable, OnCancelListener cancelListener) {
