 ...
 */
public class LinkWordMovementMethod extends LinkMovementMethod {
    ...
    private LinkWordMovementMethod() {
    }

    public static MovementMethod getInstance() {
        if (sInstance == null)
            synchronized (LinkWordMovementMethod.class) {
                if (sInstance == null) {
                    sInstance = new LinkWordMovementMethod();
                }
            }
        return sInstance;
    }
    ...
    public boolean onTouchEvent(TextView textView, Spannable spannable, MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (mPressedSpan != null) {
                ...
                mClickText = textView.getText().subSequence(start, end);
            ...
            if (mPressedSpan != null) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    //click callback
                    mPressedSpan.setPressed(true, mClickText);
