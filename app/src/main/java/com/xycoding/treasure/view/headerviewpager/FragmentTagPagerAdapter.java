...
public abstract class FragmentTagPagerAdapter extends PagerAdapter {
    ...
    public FragmentTagPagerAdapter(@NonNull FragmentManager fm) {
        mFragmentManager = fm;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (fragment != null) {
            if (DEBUG) Log.v(TAG, "Showing item #" + position + ": f=" + fragment);
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        if (DEBUG) Log.v(TAG, "Hiding item #" + position + ": f=" + object
