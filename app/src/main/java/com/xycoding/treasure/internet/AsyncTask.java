...
public abstract class AsyncTask<Params, Progress, Result> {
     ...
     */
    public static final Executor SERIAL_EXECUTOR = Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB
            ? new SerialExecutor() : Executors.newSingleThreadExecutor(sThreadFactory);
